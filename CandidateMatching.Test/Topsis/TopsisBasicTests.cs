...
public class Tests
{
    ...
    [Test]
    public void PerformRanking_YieldsCorrectClosenessFactorsWith5()
    {
        // Arrange
        var candidates = new List<CandidateDto>
        {
        ...
        var correctRelativeClosenessToIdealSolution = new double[] { 0.757, 0.601, 0.498, 0.498, 0.465 };
        // Act
        var result = _topsisService.PerformRanking(candidates: candidates, weights: weights);
    ...
    [Test]
    public void PerformRanking_YieldsCorrectClosenessFactorsWith3()
    {
        // Arrange
        var candidates = new List<CandidateDto>
        {
